                        ...
                        <div class="input-group ">
                            ...
                            <span class="input-group-btn">
								<a class="btn btn-primary" target="_blank"
                                   onclick="return downloadFileSelect(this)">下载</a>
							</span>
                        </div>
                    </div>
                </div>
                ...
                <c:forEach var="file" items="${files }">
                    <tr>
                        ...
                        <td><a href="#" fileType="${file.fileType }"
                               path="${file.filePath }" onclick="return preDirectory(this)"><span
                                class="glyphicon glyphicon-${file.fileType }"
                                style="padding-right: 10px"></span>${file.fileName }</a></td>
                        <td><a href="#"
                               class="glyphicon glyphicon-download-alt" onclick="downloadFile(this)" title="下载"></a>
                        </td>
                        <td>${file.fileSize }</td>
                        <td>${file.lastTime }</td>
                    </tr>
