            ...
            <ul>
                ...
                <li class="list-border">
                    ...
                    <div style="display: none;border: 0;" class="list-table" id="div2">
                        ...
                        <span onclick="revertAllFiles()" class="para1" id="revert"
                              style="margin-top:4px;float: left;margin-left: 1.5%;">
                ...
                <c:forEach items="${findDelFile}" var="delFile" varStatus="index">
                    <li class="list-tr" class="list-border" style="cursor:pointer;"
                        onmouseover="mouseOver(${index.index})" onmouseout="mouseOut()">
                        ...
                        <span style="float:left;margin-top: 0.5%;width:5%;">
										...
										<img style="float: left;margin-left: 10px;" onclick="delFile(this)"
                                             class="addSrc" src=""/>
								</span>
