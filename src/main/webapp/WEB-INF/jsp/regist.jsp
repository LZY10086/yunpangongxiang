...
<div class="header">
    ...
    <div class="login">
        <span>我已注册，现在就</span> <a href="user/tologin" class="login_icon">登录</a>
    </div>
    <div class="hr"></div>
</div>
<!--header结束-->
    ...
    <div class="reg">
        <form action="user/regist.action" method="post">
            <dl>
                <dt>用户名</dt>
                <dd class="ipt_box">
                    <input id="usr" name="username" type="text" placeholder="请设置用户名" /> <span id="msg"
                        class="clear"></span>
                </dd>
                <dd class="mes">
                    <div class="tip">
...
<script>
    window.onload =function () {
        var nameElement = document.getElementById(usr);
                ...
                if(xhr.readyState==4){
                    if(xhr.status()==200){
                        ...
                        if(xhr.responseText=="true"){
                            ...
                            msg.innerHTML="<font color='red'>可以使用</font>"
                        }
                    }
                }
            }
